...
const Header = () => (
  <Fragment>
    <svg className="sr-only">
      <symbol id="argos-logo" xmlns="http://www.w3.org/2000/svg" width="180" height="154.3" viewBox="0 0 180 154.3">
        <title id="argos-logo-title">Argos logo</title>
        <path fill="red" d="M180.2 154.49V.19H-.62v154.3h180.84z" />
        <g transform="translate(291 311.5) scale(.52724)">
          <path fill="#fff" d="M-382.8-372.24c67.8 0 115.7-26.8 136.2-40.1 3.5-2.2 1.5-5.8-2.3-4.3-52.3 21.5-86.2 29.4-133.9 29.4s-81.6-7.9-133.9-29.4c-3.8-1.5-5.8 2-2.3 4.3 20.6 13.3 68.4 40.1 136.2 40.1" />
        </g>
    ...
    <header className={`font-standard xs-row ${styles.header}`}>
      <div className={`container ${styles['header-container']}`}>
        <div className="xs-row">
          <div className={`logo-container ${styles['logo-container']}`}>
            <svg className={`xs-row ${styles.logo}`} aria-labelledby="argos-logo-title" role="img">
              <use xlinkHref="#argos-logo" width="100%" height="100%" />
            </svg>
          </div>
        </div>
      </div>
